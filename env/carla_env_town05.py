...
class InterSection(gym.Env):
    ...
    def reset(self):
        ...
        _map_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'map', 'town05')
        try:
            self.wp  = np.load(os.path.join(_map_dir, 'town05_left_route1.npy'))
            self.wp2 = np.load(os.path.join(_map_dir, 'town05_left_route2.npy'))
        except FileNotFoundError:
            raise FileNotFoundError(
                "town05_left_route1.npy / town05_left_route2.npy not found. "
